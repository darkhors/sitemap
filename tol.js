...
function showFeedList(t) {
    ...
    if (typeof (t.feed.entry) !== "undefined") {
        for (var f = 0; f < tocConfig.feedNum; f++) {
            ...
            c += "<a href='" + n + "' target='_blank'class=" tooltip-bottom" data-tooltip="I’m the tooltip text."><img style='width:" + tocConfig.thumbWidth + "px;height:" + tocConfig.thumbWidth + "px;' src='" + h + "' alt='" + s + "' /></a>";
