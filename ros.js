...
function showFeedList(t) {
    ...
    if (typeof (t.feed.entry) !== "undefined") {
        for (var f = 0; f < tocConfig.feedNum; f++) {
            ...
            c += "<li><div class='post-outer'>";
            c += "<a href='" + n + "' target='_blank'class=" tooltip-bottom" data-tooltip=" + cropFeed(e, tocConfig.numChars) + "><img style='width:" + tocConfig.thumbWidth + "px;height:" + tocConfig.thumbWidth + "px;' src='" + h + "' alt='" + s + "' /></a>";
